...
Both the Stan name and logo may be freely used when referencing Stan, for example, in blog posts, lecture notes,
...
When using the Stan logo please use either the [Stan Logo png](https://github.com/stan-dev/logos/blob/master/logo_tm.png) or the
...
* Write - If you'd like to contribute [case studies](../learn-stan/case-studies),
[tutorials](../learn-stan/tutorials) and similar materials, please make a post on the
[Stan forums publicity category](https://discourse.mc-stan.org/c/publicity), and tag
the `@Stan_Development_Team`.
