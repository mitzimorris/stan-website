...
* Radford Neal. 2011. [MCMC Using Hamiltonian Dynamics](http://www.mcmchandbook.net/HandbookChapter5.pdf).  In *Handbook of Markov Chain Monte
...
* Andrew Gelman, Aki Vehtari, Daniel Simpson, Charles C. Margossian, Bob Carpenter, Yuling Yao, Lauren Kennedy, Jonah Gabry, Paul-Christian Bürkner, Martin Modrák. 2020. [Bayesian Workflow](https://arxiv.org/pdf/2011.01808)
...
* Korner-Nievergelt, F., Roth, T., Von Felten, S., Guélat, J., Almasi,
  ...
  Ecology Using Linear Models with R and Stan*](https://tobiasroth.github.io/BDAEcology/).  Online.
...
* Johnson, A.A., M. Q. Ott, M. Dogucu. 2021. [*Bayes Rules! An Introduction to Applied Bayesian Modeling*](https://www.bayesrulesbook.com) CRC Press.
...
* Hilbe, J. M., R.S. de Souza, and E. E. O. Ishida.  2017. [*Bayesian
  Models for Astrophysical Data Using R, JAGS, Python and Stan*](https://www.bayesianmodelsforastrophysicaldata.com).
  Cambridge University Press.

* Matsuura, K.. 2016. [*Bayesian Statistical Modeling Using Stan
  and R*](https://link.springer.com/book/10.1007/978-981-19-4755-1). Wonderful R Series, Volume 2. Kyoritsu Shuppan Co.,
  Ltd.  [in Japanese]

* McElreath, R.  2016. [*Statistical Rethinking:  A Bayesian
  Course with R and Stan*](https://xcelab.net/rm/).  Chapman-Hall/CRC.
...
* Gelman, A., Carlin, J.B., Stern, H.S., Dunson, D.B., Vehtari, A. and
  Rubin, D.B. 2013. [*Bayesian Data Analysis*](http://www.stat.columbia.edu/~gelman/book/), Third
