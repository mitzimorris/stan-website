...
To get started using Stan you have several options to choose from, depending on your modeling needs and experience.

- **Use the Stan Language for model specification**:</br>
Stan is available for all major operating systems and several programming languages, see section [Download and Install Stan](#sec-install).

- **Use a Stan-based modeling-package**:</br>
If you'd rather specify models using formula-based syntax, skip to [High-level Stan Interfaces](#high-level-stan-interfaces).
...
|--------------|----------|-----------------|
| **R, Python**      | [**Google Colab**](https://github.com/stan-dev/cmdstan/releases) | Prebuilt CmdStan binaries for Google Colab are available from the GitHub CmdStan releases page. Installing these binaries at the start of a Colab session is much faster than installing CmdStan during a Colab session.                            |
| **Mathematica** | [**MathematicaStan**](https://github.com/stan-dev/MathematicaStan) | Stan interface for Mathematica. Available from its GitHub repository.|
| **MATLAB**      | [**MatlabStan**](https://github.com/brian-lau/MatlabStan/wiki) | Installation instructions available on the MatlabStan wiki.|
| **Python**      | [**PyStan**](https://pystan.readthedocs.io/)                             | Available via pip. Run command: `python -m pip install pystan`.|
...
| **R**        | [**Rethinking**](https://github.com/rmcelreath/rethinking) | Accompanies the book and course materials for [Statistical Rethinking, 2nd Ed](https://www.taylorfrancis.com/books/mono/10.1201/9780429029608/statistical-rethinking-richard-mcelreath) by Richard McElreath.|
