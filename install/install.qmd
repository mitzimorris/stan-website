...
| **R**        | [**Rethinking**](https://github.com/rmcelreath/rethinking){target="_blank"} | Accompanies the book and course materials for [Statistical Rethinking, 2nd Ed](https://www.taylorfrancis.com/books/mono/10.1201/9780429029608/statistical-rethinking-richard-mcelreath){target="_blank"} by Richard McElreath.|
| **Python**   | [**Bambi**](https://bambinos.github.io/bambi/){target="_blank"} | Bayesian models in Python using formula syntax, built on top of Stan and PyMC. |
...
<table>
  ...
  <tbody>
    <tr>
      <td colspan="2" style="border-bottom: 1px solid #ccc; height: 5px;"></td>
    </tr>
    <!-- CmdStanPy Section -->
    <tr>
      <td rowspan="3"><strong>CmdStanPy</strong></td>
      <td><a href="https://mc-stan.org/cmdstanpy/users-guide/hello_world.html" target="_blank">CmdStanPy "Hello, World!"</a></td>
    </tr>
    <tr>
      <td><a href="https://github.com/bob-carpenter/stan-getting-started" target="_blank">Getting Started with Bayesian Statistics using Stan and Python</a></td>
    </tr>
    <tr>
      <td><a href="case-studies/radon_cmdstanpy_plotnine.html" target="_blank">Multilevel regression modeling with CmdStanPy and plotnine</a></td>
    </tr>
    <!-- Separator Row -->
    <tr>
      <td colspan="2" style="border-bottom: 1px solid #ccc; height: 5px;"></td>
    ...
    <!-- CmdStanR Section -->
    <tr>
      <td rowspan="2"><strong>CmdStanR</strong></td>
      <td><a href="https://mc-stan.org/cmdstanr/articles/cmdstanr.html" target="_blank">Getting Started with CmdStanR</a></td>
    </tr>
    <tr>
      <td><a href="https://github.com/charlesm93/stanTutorial/blob/main/StanCon2023/Stan_tutorial.ipynb" target="_blank">StanCon2023/Stan_tutorial.ipynb</a></td>
    </tr>
    <!-- Separator Row -->
    <tr>
      <td colspan="2" style="border-bottom: 1px solid #ccc; height: 5px;"></td>
    ...
    <tr>
      ...
      <td><a href="https://github.com/StanJulia/Stan.jl/tree/master/Examples" target="_blank">Stan.jl Examples</a></td>
    </tr>
    <!-- Separator Row -->
    <tr>
      <td colspan="2" style="border-bottom: 1px solid #ccc; height: 5px;"></td>
    ...
    <tr>
      ...
      <td><a href="https://mc-stan.org/users/documentation/case-studies/jupyter_colab_notebooks_2020.html" target="_blank">Stan Notebooks in the Cloud</a></td>
    </tr>
  </tbody>
</table>
