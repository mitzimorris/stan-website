...
| **LaTeX Editors**              | [**minted**](https://github.com/gpoore/minted){target="_blank"} </br>[**lstbayes**](https://github.com/jrnold/lstbayes){target="_blank"} | LaTeX package that uses the Pygments library </br>LaTeX listings for Stan syntax highlighting. |
