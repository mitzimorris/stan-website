...
under the direction of the [Stan Governing Body](sgb.qmd)
...
When using the Stan logo please use the version linked below,

<script type="text/javascript">
  disableOn = 0;
</script>
* <p><a href="https://github.com/stan-dev/logos/blob/master/logo_zissou_tm.svg">SVG</a></p>
